...
import com.filetransfer.repository.ImageRepository;
...
public class ImageUploadController {
    ...
    public ImageModel getImage(@PathVariable("imageName") String imageName) throws IOException {
        ...
        ImageModel img = new ImageModel(retrievedImage.get().getName(), retrievedImage.get().getType(), decompressedBytes(retrievedImage.get().getPicByte()));
        return img;
    }
